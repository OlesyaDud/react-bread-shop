...
export const logout = () => (dispatch) => {
    ...
    // to reset, get rid of storage data upon loging
...
export const updateUser =(user) => async (dispatch, getState) => {
    ...
    // in a variable storing data that getting from this req
